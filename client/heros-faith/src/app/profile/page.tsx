            ...
            <div className="lg:col-span-3">
              <div className="bg-white/5 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/10 p-6 flex flex-col items-center">
                ...
                {user.role === 'admin' && (
                  <Link
                    href="/admin"
                    className="w-full mt-3 bg-red-500/20 hover:bg-red-500/30 backdrop-blur-sm border border-red-500/30 text-red-300 font-semibold py-3 px-6 rounded-xl transition-all duration-300 hover:shadow-lg text-center no-underline block flex items-center justify-center gap-2"
                  >
